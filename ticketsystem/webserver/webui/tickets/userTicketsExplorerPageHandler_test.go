...
*/
func TestUserTicketsExplorerPageHandler_ServeHTTP_ValidRequest(t *testing.T) {
...
*/
func TestUserTicketsExplorerPageHandler_ServeHTTP_WrongRequestMethod(t *testing.T) {
	mockedTicketContext := new(mockedForTests.MockedTicketContext)
	mockedTemplateManager := new(templateManager.MockedTemplateManager)
...
*/
func TestUserTicketsExplorerPageHandler_ServeHTTP_ContextError_RenderError(t *testing.T) {
	mockedTicketContext := new(mockedForTests.MockedTicketContext)
	mockedTemplateManager := new(templateManager.MockedTemplateManager)
